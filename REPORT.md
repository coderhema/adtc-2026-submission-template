# Technical Report - Hekima AI: Offline Multilingual Exam Tutor
...
**Hekima AI** is a fully offline, on-device exam tutor that solves past-paper questions step by step in the student's own language - Yoruba, Hausa, Swahili, Igbo, or English - on the 8 GB integrated-GPU laptops that are already common across the continent. A student types or pastes a WAEC-style question (or asks for practice from a topic), and the model explains the solution methodically, the way a patient teacher would. No cloud, no API fees, no connectivity required.
...
- **Training data (verified available on Hugging Face):**
  ...
  - Curated bilingual QA pairs (English / Yoruba / Hausa / Swahili / Igbo) generated from WAEC, NECO and GCE past-paper patterns; Yoruba, Hausa and Igbo flagged for native-speaker validation.
...
- `data/` - curated exam QA (AfriGSM subset + WAEC past questions + bilingual pairs)
